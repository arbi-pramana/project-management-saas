                ...
                <ul class="navbar-nav header-right">
                    ...
                    <li class="nav-item dropdown header-profile">
                        <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                            <svg id="icon-user1" xmlns="http://www.w3.org/2000/svg" class="text-primary" width="25" height="25" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                            <div class="header-info">
                                <span class="text-black"><strong>{{Auth::guard('users')->user()->name}}</strong></span>
                                <p class="fs-12 mb-0">Account</p>
                            </div>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
                            <a href="{{route('users.profile.index')}}" class="dropdown-item ai-icon">
                            ...
                            <a href="{{route('users.logout')}}" class="dropdown-item ai-icon">
