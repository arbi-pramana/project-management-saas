                        ...
                        <tbody>
                            @foreach($milestones as $i => $milestone)
                                <tr>
                                    ...
                                    <td>
                                        <span>
                                            <a href="#" class="mr-4" id="edit-{{$milestone->id}}" data-name="{{$milestone->name}}" data-toggle="tooltip" data-placement="top" title="Edit" onclick="editData('{{$milestone->id}}')"><i class="fa fa-pencil color-muted"></i></a>
                                            <a href="#" data-id="{{$milestone->id}}" data-name="{{$milestone->name}}" data-placement="top" data-toggle="tooltip" title="Delete" onclick="deleteData('{{$milestone->id}}')"><i class="fa fa-close color-danger"></i></a></span>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
