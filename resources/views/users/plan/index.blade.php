                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="text-center">
                            <a href="{{url('https://api.whatsapp.com/send?phone=6285156585179&text=Halo%2C%20Pimku%20-%20CS%2C%0A%0ASaya%20'.\Auth::guard('users')->user()->name.'%2C%20dengan%20email%20%3A%20'.\Auth::guard('users')->user()->email.'%0ASaya%20ingin%20upgrade%20system%20saya%20ke%20*Dedicated%20System*')}}" class="btn btn-success"><i class="fa fa-phone"></i> Contact Us</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <br><br>
                        <div class="text-center">
                            <a href="{{url('https://api.whatsapp.com/send?phone=6285156585179&text=Halo%2C%20Pimku%20-%20CS%2C%0A%0ASaya%20'.\Auth::guard('users')->user()->name.'%2C%20dengan%20email%20%3A%20'.\Auth::guard('users')->user()->email.'%0ASaya%20ingin%20upgrade%20system%20saya%20ke%20*Custom%20System*')}}" class="btn btn-success"><i class="fa fa-phone"></i> Contact Us</a>
                        </div>
                    </div>
                </div>
            </div>
